        ...
        return (
          ...
          >
            ...
            <div className="flex flex-row lg:flex-col gap-3 w-full lg:w-auto shrink-0 border-t lg:border-t-0 pt-4 lg:pt-0 border-white/5">
              {/* Comprobante Link */}
              <a 
                href={sol.paymentProofUrl} 
                target="_blank" 
                rel="noreferrer" 
                className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white border border-white/10 px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex-1 lg:flex-none"
              >
                <FileText size={14} />
