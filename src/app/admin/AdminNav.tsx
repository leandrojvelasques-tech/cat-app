...
import { Users, CreditCard, LayoutDashboard, Settings, Archive, Calendar, Trophy, ShieldCheck, ShoppingBag } from "lucide-react"
...
export function AdminNav() {
  ...
  const links = [
    ...
    { href: "/admin/buffet", icon: ShoppingBag, label: "Catálogo Buffet" },
