    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl animate-in fade-in duration-200">
          <div className="bg-zinc-900 border border-white/10 p-8 md:p-10 rounded-[48px] max-w-lg w-full shadow-[0_0_100px_rgba(0,0,0,0.5)] space-y-8 animate-in zoom-in-95 duration-200 overflow-hidden relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
              ...
              <div className="bg-white/5 rounded-[32px] p-6 border border-white/5 space-y-6">
                <div className="space-y-1">
                   ...
                   <p className="text-white font-black text-sm uppercase">{format(payment.date, "eeee dd 'de' MMMM", { locale: es })}</p>
                   <p className="text-xs text-zinc-500 font-bold">{format(payment.date, "HH:mm")} hs</p>
                </div>
